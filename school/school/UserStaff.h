...
namespace school {
	...
	/// <summary>
	/// Summary for UserStaff
	/// </summary>
	public ref class UserStaff : public System::Windows::Forms::Form
	{
	public:
		UserStaff(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(UserStaff::typeid));
			...
			this->Name = L"UserStaff";
			this->Text = L"UserStaff";
