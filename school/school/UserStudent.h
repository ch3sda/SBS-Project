...
namespace school {
	...
	/// <summary>
	/// Summary for UserStudent
	/// </summary>
	public ref class UserStudent : public System::Windows::Forms::Form
	{
	public:
		UserStudent(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(UserStudent::typeid));
			...
			this->label1->Click += gcnew System::EventHandler(this, &UserStudent::label1_Click);
			// 
			// pictureBox6
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &UserStudent::button4_Click);
			// 
			// pictureBox4
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &UserStudent::button3_Click);
			// 
			// button2
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &UserStudent::button1_Click);
			// 
			// panel2
			// 
			...
			this->QuitButton->Click += gcnew System::EventHandler(this, &UserStudent::QuitButton_Click);
			// 
			// panel4
			// 
			this->panel4->Location = System::Drawing::Point(236, 1);
			this->panel4->Name = L"panel4";
			this->panel4->Size = System::Drawing::Size(952, 678);
			this->panel4->TabIndex = 18;
			this->panel4->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &UserStudent::panel4_Paint);
			// 
			// UserStudent
			// 
			...
			this->Name = L"UserStudent";
			this->StartPosition = System::Windows::Forms::FormStartPosition::Manual;
			this->Text = L"UserStudent";
			this->Load += gcnew System::EventHandler(this, &UserStudent::UserStudent_Load);
...
#pragma endregion
	private: System::Void UserStudent_Load(System::Object^ sender, System::EventArgs^ e) {
	}
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	StuProfile^ studentprofile = gcnew StuProfile(label1->Text);
...
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	StudentSetting^ stdsetting = gcnew StudentSetting();
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	StuSchool^ stuschool = gcnew StuSchool();
	stuschool->ShowDialog();
}
};
}
